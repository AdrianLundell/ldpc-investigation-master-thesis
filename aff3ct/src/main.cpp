...
struct params 
{
    ...
    std::string reader_fpath = "data/reader_files/Symmetric_single_soft.csv";
	std::string output_fpath = "../../python-files/PyBER/data/Symmetric_soft_test.txt";
	std::string ldpc_fpath = "../../python-files/Codec/1_edge_regular.qc";
